...
import com.douglas.develop.radio.service.AgendamentoService;
...
public class AgendamentoController {
	...
	// abrit pagina de historico de atendimento do paciente
	@PreAuthorize("hasAnyAuthority('PACIENTE', 'MEDICO')")
	...
	//localiza agendamento pelo id e envi-lo para a pagina de cadastro
	@PreAuthorize("hasAnyAuthority('PACIENTE', 'MEDICO')")
